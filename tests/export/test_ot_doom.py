...
snare, hat); chain[k] = stack across stems of (segment_k(input_0) ++
… ++ segment_k(input_{N-1})). N flex slots per pattern, each holding
3 * N slices. N trigs on each of T1/T2/T3 at intervals of 16/N.
Per-track scenes on part 1 address each stem's N-slice range.
