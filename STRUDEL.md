...
repo — `app/launch/tempera.strudel.js` (the capture template) and
the playback template generated by `app/export/strudel/` both run
through Strudel's transpile pipeline and inherit the same constraints.
